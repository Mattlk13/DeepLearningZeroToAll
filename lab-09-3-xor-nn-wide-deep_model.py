...
predicted = tf.cast(hypothesis > 0.5, dtype=tf.float32, name='prediction')
...
with tf.Session() as sess:
    ...
    coldGraph(sess, 'lab_09_3_xor_nn_wide_deep', "X", "hypothesis, prediction, accuracy", "save/Const:hypothesis, save/Const:prediction, save/Const:accuracy" )
