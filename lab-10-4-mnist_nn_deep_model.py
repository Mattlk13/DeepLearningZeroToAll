...
hypothesis =  tf.add(tf.matmul(L4, W5),  b5, name='hypothesis')
...
coldGraph(sess, 'lab_10_4_mnist_nn_deep', "X", "hypothesis, prediction, accuracy", "save/Const:hypothesis, save/Const:prediction, save/Const:accuracy" )
