...
prediction = tf.arg_max(hypothesis, 1, name='prediction')
...
with tf.Session() as sess:
    ...
    coldGraph(sess, 'lab_07_1_learning_rate_and_evaluation', "X", "hypothesis, prediction, accuracy", "save/Const:hypothesis, save/Const:prediction, save/Const:accuracy" )
