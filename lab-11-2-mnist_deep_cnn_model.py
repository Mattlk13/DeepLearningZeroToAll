...
logits = tf.add( tf.matmul(L4, W5), b5, name='hypothesis')
...
# initialize
# Just use CPU, when GPU causes the failed (resouces exhausted ....)
...
coldGraph(sess, 'lab_11_2_mnist_deep_cnn', "X", "hypothesis, prediction, accuracy", "save/Const:hypothesis, save/Const:prediction, save/Const:accuracy" )
