...
logits = tf.add(tf.matmul(L2_flat, W3), b, name='hypothesis')
...
coldGraph(sess, 'lab_11_1_mnist_cnn', "X", "hypothesis, prediction, accuracy", "save/Const:hypothesis, save/Const:prediction, save/Const:accuracy" )
